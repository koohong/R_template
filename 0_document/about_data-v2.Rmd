...
# emergencyMedical$medical_institution_type

# emergencyMedical_type1

## emergency_medical_institution_type

# emergencyMedical$emergency_medical_institution_type

# emergencyMedical_type2


# 5. pedestrian accident

## severity
pedestrianAccident_severity

severity_description <- data.frame(description = c("an injury requiring treatment for at least three weeks","an injury requiring treatment for more than 5 days and less than 3 weeks","an injury requiring treatment for less than 5 days","the case of death within 30 days of the occurrence of a traffic accident", "no injury requireing treatment for", "unidentified"))

severity_descTable <- cbind(pedestrianAccident_severity[,-2],severity_description)
kable(severity_descTable,caption = "Description severity column in pedestrian accident")
