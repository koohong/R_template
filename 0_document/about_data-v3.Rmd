...
path <- paste0("E:/Severity/R_template/")
rawPath <- paste0(path,"1_raw_data/old/")
...
colnames(useDistrict_descTable)[1] <- "type"
...
severity_description <- data.frame(description = c("an injury requiring at least three weeks of treatment","an injury requiring treatment for not less than five days but not more than three weeks","an injury requiring less than five days of treatment","death within 30 days of the occurrence of a traffic accident","no injury","unidendified"))

severity_descTable <- cbind(pedestrianAccident_severity[,-2],severity_description)
colnames(severity_descTable)[1] <- "severity"
